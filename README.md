...
This is an open source sharing economy app named Freedom.

It is based on the GRANDstack Starter (https://grandstack.io) (GraphQL, React, Apollo, Neo4j Database) application and Google Maps.
